...
-DCMAKE_FORCE_C_COMPILER="gcc gcc" \
-DCMAKE_FORCE_CXX_COMPILER="g++ g++" \
-DCMAKE_CXX_COMPILER_WORKS=YES \
-DCMAKE_C_COMPILER_WORKS=YES \
-DBUILD_SHARED_LIBS=NO \
-DOpenCV_DIR=/Users/phil/Downloads/wat/opencv_ios/tmp/ios-dev-build \
...
-DBUILD_PERF_TESTS=NO \
-DBUILD_SHARED_LIBS=NO \
-DOpenCV_DIR=/Users/phil/Downloads/wat/opencv_ios/tmp/ios-sim-build \
-DCMAKE_XCODE_ATTRIBUTE_GCC_VERSION="com.apple.compilers.llvmgcc42" $SRC
...
do
  lipo $IOS_DEV_BUILD_DIR/lib/Release-iphoneos/$FILE \
       $IOS_SIM_BUILD_DIR/lib/Release-iphonesimulator/$FILE \
...
do
lipo $IOS_DEV_BUILD_DIR/lib/Debug-iphoneos/$FILE \
$IOS_SIM_BUILD_DIR/lib/Debug-iphonesimulator/$FILE \
